...
public class JoinGame extends VBox {
	...
	/** Label for displaying the status of player. Whether he connected to your Game or not */
	private final Label connectionStatus;

	
	//__________String Constants__________
	private String _WAITING = "Welcome";
...
//		player2Status.setPrefWidth(3 * PaperFootball.LINE_LENGTH);
	...
	public void setPlayerName(String playerName) {
		_WAITING += " " + playerName;
		connectionStatus.setText(_WAITING);
	}
}